...
* uv run python .\src\producers\producer_green-trips.py
* 848 seconds
...
* docker compose exec jobmanager ./bin/flink run -py /opt/src/job/trip_distance_green-trips_job.py --pyFiles /opt/src -d
